...
\justify
Le funzioni per la generazione di grafi \textit{gnp\_random\_graph} sono raggiungibili all'interno del programma generator.py selezionando la modalità di esecuzione MULTIPLE MODE e selezionando in seguito la classe \textit{gnp\_random\_graph}.\\
